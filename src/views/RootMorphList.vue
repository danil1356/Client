<template>
  ...
  <div class="panel panel-primary" style="margin-top: 10px">
    <div class="panel-heading">Список корневых морфем</div>
    <div class="panel-body">
      <router-link role="button" class="btn btn-lg btn-block btn-default" :to="{name: 'editRoot', params: {id: 0}}">
        Добавить
      </router-link>
    </div>
    ...
    <table id="table_id" class="table table-striped">
      ...
      <tr>
        <th>№</th>
        <th style="width: 65%">Корневая морфема</th>
      ...
      <tr v-for="(item, index) in rootItems" :key="index">
        ...
        <td>
          <router-link role="button" class="btn btn-sm btn-link" :to="{name: 'editRoot', params: {id: item.id}}">
